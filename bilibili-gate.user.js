...
// @require      https://registry.npmmirror.com/framer-motion/11.12.0/files/dist/framer-motion.js
...
(async function (dayjs, duration, React__default, UAParser, axios, antd, cssinjs, zhCN, require$$0, localforage, framerMotion) {
  ...
  const IconForDislike = phThumbsDownDuotone;
  const IconForConfig = iconParkOutlineConfig;
  const IconForPlayer = iconParkOutlinePlayTwo;
  const IconForOpenExternalLink = materialSymbolsLightOpenInNew;
  const IconForAsc = tablerSortAscending2;
  const IconForDesc = tablerSortDescending2;
  const IconForDefaultOrder = mdiShuffleDisabled;
  const IconForShuffle = cuidaShuffleOutline;
  ...
  function runSettingsMigration(val) {
    const config = [["dynamicFeed.showLive", "dynamicFeedShowLive"], ["dynamicFeed.followGroup.enabled", "dynamicFeedFollowGroupEnabled"], ["dynamicFeed.followGroup.forceUseMergeTimelineIds", "dynamicFeedFollowGroupForceUseMergeTimelineIds"], ["dynamicFeed.whenViewAll.enableHideSomeContents", "dynamicFeedWhenViewAllEnableHideSomeContents"], ["dynamicFeed.whenViewAll.hideIds", "dynamicFeedWhenViewAllHideIds"], ["dynamicFeed.advancedSearch", "dynamicFeedAdvancedSearch"], ["fav.useShuffle", "favUseShuffle"], ["fav.addSeparator", "favAddSeparator"], ["fav.excludedFolderIds", "favExcludedFolderIds"], ["filter.enabled", "filterEnabled"], ["filter.minPlayCount.enabled", "filterMinPlayCountEnabled"], ["filter.minPlayCount.value", "filterMinPlayCount"], ["filter.minDuration.enabled", "filterMinDurationEnabled"], ["filter.minDuration.value", "filterMinDuration"], ["filter.exemptForFollowed.video", "exemptForFollowedVideo"], ["filter.exemptForFollowed.picture", "exemptForFollowedPicture"], ["filter.hideGotoTypePicture", "filterOutGotoTypePicture"], ["filter.hideGotoTypeBangumi", "filterOutGotoTypeBangumi"], ["filter.byAuthor.enabled", "filterByAuthorNameEnabled"], ["filter.byAuthor.keywords", "filterByAuthorNameKeywords"], ["filter.byTitle.enabled", "filterByTitleEnabled"], ["filter.byTitle.keywords", "filterByTitleKeywords"], ["style.general.videoSourceTabStandardHeight", "styleUseStandardVideoSourceTab"], ["style.pureRecommend.useStickyTabbar", "styleUseStickyTabbarInPureRecommend"], ["style.pureRecommend.useCustomGrid", "styleUseCustomGrid"], ["style.pureRecommend.useWhiteBackground", "styleUseWhiteBackground"], ["style.pureRecommend.hideTopChannel", "styleHideTopChannel"], ["style.videoCard.useBorder", "styleUseCardBorder"], ["style.videoCard.useBorderOnlyOnHover", "styleUseCardBorderOnlyOnHover"], ["style.videoCard.useBoxShadow", "styleUseCardBoxShadow"], ["style.videoCard.usePadding", "styleUseCardPadding"]];
...
`;
  ...
  const tablerPlus = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const IconForUp = radixIconsPerson;
  const IconForGroup = mynauiUsersGroup;
  const IconForPopoverTrigger = tablerPlus;
  ...
  function RankingNumMark({
    ...
    const tooltip2 = `「${category.name}」排行第 ${item.rankingNo} 名`;
    const {
      triggerRef,
      tooltipEl
    } = useTooltip({
  ...
  function __FlagSettingItem({
    ...
    if (as === "checkbox") {
      ...
      if (tooltip2) inner = wrapTooltip(inner);
    ...
    if (as === "switch") {
      ...
      if (tooltip2) content = wrapTooltip(content);
      return content;
    }
  }
  ...
  const lucideList = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const lucideFolderLock = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const lucideFolder = (props) => /* @__PURE__ */ jsx("svg", {
    viewBox: "0 0 24 24",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const ionLayersOutline = (props) => /* @__PURE__ */ jsxs("svg", {
    viewBox: "0 0 512 512",
    width: "1.2em",
    height: "1.2em",
    ...props,
  ...
  const IconForAll = lucideList;
  const IconForPrivateFolder = lucideFolderLock;
  const IconForPublicFolder = lucideFolder;
  const IconForCollection = ionLayersOutline;
  function FavUsageInfo({
    ...
    return /* @__PURE__ */ jsxs(antd.Space, {
      ref,
      size: 10,
      children: [scopeSelectionDropdown, showShuffle && /* @__PURE__ */ jsx(ShuffleSettingsItemFor, {
...
`;
  ...
  class FavAllService {
    ...
    get extraUsageInfo() {
      return /* @__PURE__ */ jsx(ViewingAllExcludeFolderConfig, {
  ...
  const FALLBACK_ORDER = "default";
  const tooltip = /* @__PURE__ */ jsxs(Fragment, {
    children: ["在 ", ORDER_LIST.map((x) => FavItemsOrderConfig[x].label).join(" / "), " 之间切换"]
  });
  function FavItemsOrderSwitcher() {
    ...
    const onToggle = useMemoizedFn(async () => {
      ...
      const next2 = ORDER_LIST[nextIndex];
  ...
  class FavCollectionService {
    ...
    setupItemsOrder(items) {
      if (this.itemsOrder === FavItemsOrder.Shuffle) {
        return shuffle(items);
      }
      if (this.itemsOrder === FavItemsOrder.PubTimeDesc || this.itemsOrder === FavItemsOrder.PubTimeAsc) {
    ...
    get usageInfo() {
      return /* @__PURE__ */ jsx(FavUsageInfo, {
        showShuffle: false,
        extraContent: /* @__PURE__ */ jsx(FavItemsOrderSwitcher, {})
      });
    }
  }
  class FavFolderService {
    constructor(entry, useShuffle, addSeparator) {
  ...
  const _FavRecService = class _FavRecService {
    constructor(config) {
      ...
      if (this.viewingAll) {
        ...
        this.innerService = new FavFolderService(this.config.selectedFavFolder, this.config.useShuffle, this.config.addSeparator);
  ...
  function PopularGeneralUsageInfo() {
    const onRefresh = useOnRefreshContext();
    const tooltip2 = /* @__PURE__ */ jsx(Fragment, {
...
`;
  ...
  function useWatchlaterRelated({
    ...
    const tooltip2 = item.api === EApiType.Watchlater ? watchlaterAdded ? "已添加稍后再看, 点击移除" : "已移除稍后再看" : watchlaterAdded ? "已添加稍后再看, 点击移除" : "稍后再看";
...
`;
  ...
  function UpTagItemDisplay({
    ...
    const tooltip2 = /* @__PURE__ */ jsxs(Fragment, {
  ...
  function DynamicFeedWhenViewAllHideIdTag({
    ...
    const tooltip2 = React__default.useMemo(() => mid ? `mid: ${mid}` : followGroupId ? `分组: ${followGroupId}` : `Tag: ${tag}`, [mid, followGroupId, tag]);
  ...
  const RefreshButton = React__default.forwardRef(function({
    ...
    const text = tab2 === ETab.DynamicFeed || tab2 === ETab.Watchlater && !watchlaterUseShuffle || tab2 === ETab.Fav && !fav.useShuffle || tab2 === ETab.Hot && !isHotTabUsingShuffle(popularWeeklyUseShuffle) || tab2 === ETab.Live ? "刷新" : "换一换";
