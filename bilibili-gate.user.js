...
(async function (dayjs, duration, React__default, UAParser, axios, antd, cssinjs, zhCN, require$$0, localforage, framerMotion) {
  ...
  const debug$b = baseDebug.extend("components:css-vars");
  debug$b(":export = %O", cssVars);
  const cssVar = (id) => {
  ...
  const internalBooleanKeys = Object.keys(initialSettings).filter((k) => k.startsWith("__internal") && typeof initialSettings[k] === "boolean");
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [/* @__PURE__ */ jsx(Global, {
        ...
        styles: [
           ...
           */
          styleUseWhiteBackground ? _ref3 : _ref2,
...
`;
  ...
  async function updateFollowGroups(force = false) {
    const enabled = settings.dynamicFeedEnableFollowGroupFilter || !!settings.dynamicFeedWhenViewAllHideIds.filter((x) => x.startsWith(SELECTED_KEY_PREFIX_GROUP)).length;
    if (!enabled) return;
    ...
    async loadMore(signal = void 0) {
      ...
      if (useSearchCache) {
        if (!this._cacheQueue) {
          ...
          this._cacheQueue.bufferQueue = (await cache$1.get(this.upMid) || []).filter((x) => {
            var _a2, _b2, _c2, _d;
  ...
  const _FavRecService = class _FavRecService {
    ...
    async getAllFolders() {
      ...
      this.folderServices = this.allFolderServices.filter((s) => !settings.favExcludedFolderIds.includes(s.entry.id.toString()));
  ...
  function FavUsageInfo({
    ...
    const handleChange = useMemoizedFn((newTargetKeys, direction, moveKeys) => {
      ...
      updateSettings({
        favExcludedFolderIds: newTargetKeys.map((k) => k.toString())
      });
    });
    const foldersCount = React__default.useMemo(() => allFavFolderServices.filter((x) => !favExcludedFolderIds.includes(x.entry.id.toString())).length, [allFavFolderServices, favExcludedFolderIds]);
    const videosCount = React__default.useMemo(() => {
      return allFavFolderServices.filter((s) => !favExcludedFolderIds.includes(s.entry.id.toString())).reduce((count, s) => count + s.entry.media_count, 0);
...
`;
  ...
  function useCardBorderCss() {
    ...
    }, [useBorder, useBorderOnlyOnHover, useBoxShadow, styleUseWhiteBackground, useDelayForHover, styleUseCardPadding]);
  }
...
`;
  ...
  function filterRecItems(items, tab2) {
    ...
    const regMid = /^\d+$/;
    settings2.filterByAuthorNameKeywords.forEach((x) => {
      var _a2, _b2;
  ...
  function useContextMenus({
    ...
    const dynamicViewStartFromHere = React__default.useMemo(() => hasEntry_dynamicFeed_offsetAndMinId && {
      label: "动态: 从此项开始查看",
      key: "动态: 从此项开始查看",
      icon: /* @__PURE__ */ jsx(tablerSortDescending2, {
        ...size(17)
      }),
      onClick() {
        var _a2;
    ...
    const dynamicViewUpdateSinceThis = React__default.useMemo(() => hasEntry_dynamicFeed_offsetAndMinId && {
      icon: /* @__PURE__ */ jsx(tablerSortAscending2, {
        ...size(17)
      }),
      label: "动态: 从此项开始截止",
      key: "动态: 从此项开始截止",
  ...
  `;
    ...
    `, (isHovering || active || styleUseCardBorder && !styleUseCardBorderOnlyOnHover) && coverBottomNoRoundCss];
    const dark = useIsDarkMode();
  ...
  async function refreshForGrid(fetcherOptions) {
    ...
    if (fetcherOptions.tab === ETab.DynamicFeed) {
      ...
      if (s.followGroupTagid || // 选择了分组 & 分组很少更新
      s.showFilter && // 过滤结果可能比较少
        ...
        children: /* @__PURE__ */ jsx(CollapsePanel, {
          ...
          children: /* @__PURE__ */ jsxs("div", {
            ...
            children: [/* @__PURE__ */ jsx(ResetPartialSettingsButton, {
              ...
              size: [20, 10],
              wrap: true,
              children: internalBooleanKeys.map((k) => /* @__PURE__ */ jsx(CheckboxSettingItem, {
                configKey: k,
                tooltip: k,
      ...
      children: [/* @__PURE__ */ jsx(SettingsGroup, {
        ...
        title: /* @__PURE__ */ jsxs(Fragment, {
          children: ["视频卡片", /* @__PURE__ */ jsx(ResetPartialSettingsButton, {
            className: "ml-10",
            keys: ["styleUseCardBorder", "styleUseCardBorderOnlyOnHover", "styleUseCardBoxShadow", "styleUseCardPadding", "useDelayForHover"]
          })]
        }),
        children: /* @__PURE__ */ jsxs("div", {
          css: S$2.itemsContainer,
        ...
        children: list.length ? /* @__PURE__ */ jsx("div", {
          ...
          children: list.map((t) => {
            return /* @__PURE__ */ jsx(TagItemDisplay, {
              tag: t,
              onDelete: (tag) => {
                const s = /* @__PURE__ */ new Set([...settings[configKey]]);
                s.delete(tag);
                updateSettings({
                  [configKey]: Array.from(s)
                });
              },
