...
declare global {
  ...
  const IconCarbonUrl: typeof import('~icons/carbon/url.jsx')['default']
  ...
  const IconLucideSquareCheck: typeof import('~icons/lucide/square-check.jsx')['default']
  ...
  const IconMaterialSymbolsLightSyncArrowDownRounded: typeof import('~icons/material-symbols-light/sync-arrow-down-rounded.jsx')['default']
