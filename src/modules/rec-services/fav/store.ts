...
import { fetchAllFavFolders } from './api'
...
export const SHOW_FAV_COLLECTION_ONLY = SHOW_FAV_TAB_ONLY && QUERY_FAV_COLLECTION_ID
export const SHOW_FAV_FOLDER_ONLY = SHOW_FAV_TAB_ONLY && QUERY_FAV_FOLDER_ID
