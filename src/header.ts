...
export const $headerHeight = valtioFactory(function calcHeaderHeight() {
...
export const $headerWidth = valtioFactory(function calcHeaderWidth(): number | undefined {
