...
import { EGridDisplayMode, ETwoColumnModeAlign } from '$enums'
...
export const clsForTwoColumnModeAlign = (pos: ETwoColumnModeAlign, mode: 'flex' | 'margin') => {
  switch (pos) {
...
export function TwoColumnModeAlignSwitcher({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <Radio.Button value={ETwoColumnModeAlign.Left} className='inline-flex-center'>
        <IconMaterialSymbolsAlignHorizontalLeft className='size-16px' />
      </Radio.Button>
      <Radio.Button value={ETwoColumnModeAlign.Center} className='inline-flex-center'>
        <IconMaterialSymbolsAlignHorizontalCenter className='size-16px' />
      </Radio.Button>
      <Radio.Button value={ETwoColumnModeAlign.Right} className='inline-flex-center'>
